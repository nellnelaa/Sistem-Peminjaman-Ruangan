    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Kelola dan pantau peminjaman ruangan secara real-time
        </p>
      </div>
          ...
          <div className="grid grid-cols-7 gap-2">
            ...
            {calendarDays.map((dayInfo, index) => {
              ...
              const statusCounts = dayInfo.peminjaman.reduce((acc, p) => {
                acc[p.status_peminjaman] = (acc[p.status_peminjaman] || 0) + 1;
                return acc;
              }, {});
          ...
          {!selectedDate ? (
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {selectedDatePeminjaman.map((peminjaman) => {
                const statusInfo = getStatusInfo(peminjaman.status_peminjaman);
                  ...
                  >
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span>{peminjaman.ruangan?.nama_ruangan || "N/A"}</span>
                      </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100">
                      <a
                        href={`/admin/peminjaman/${peminjaman.id}`}
